...
exports.FeeTypesModule = FeeTypesModule = __decorate([
    (0, common_1.Module)({
        ...
        providers: [fee_types_service_1.FeeTypesService, fee_types_repository_1.FeeTypesRepository],
        exports: [fee_types_service_1.FeeTypesService, fee_types_repository_1.FeeTypesRepository],
    })
], FeeTypesModule);
